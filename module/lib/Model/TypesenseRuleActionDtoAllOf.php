...
/**
 * TypesenseRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TypesenseRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TypesenseRuleActionDto_allOf';
    ...
    */
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $host when calling TypesenseRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setIndexName($index_name)
    {
        ...
        if ((mb_strlen($index_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $index_name when calling TypesenseRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling TypesenseRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
