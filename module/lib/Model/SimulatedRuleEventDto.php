...
class SimulatedRuleEventDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'action_data' => 'string',
        'error' => 'string',
        'skip_reasons' => '\OpenAPI\Client\Model\SkipReason[]'
    ];
    ...
    */
     ...
     * Gets skip_reasons
     *
     * @return \OpenAPI\Client\Model\SkipReason[]
     */
     ...
     * Sets skip_reasons
     *
     * @param \OpenAPI\Client\Model\SkipReason[] $skip_reasons The reason why the event has been skipped.
     *
     * @return self
     */
