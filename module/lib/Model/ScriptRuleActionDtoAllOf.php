...
/**
 * ScriptRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ScriptRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScriptRuleActionDto_allOf';
    ...
    */
    ...
    public function setScript($script)
    {
        ...
        if ((mb_strlen($script) < 1)) {
            throw new \InvalidArgumentException('invalid length for $script when calling ScriptRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
