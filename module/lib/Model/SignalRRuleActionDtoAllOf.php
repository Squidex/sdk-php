...
/**
 * SignalRRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SignalRRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignalRRuleActionDto_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'hub_name' => 'string',
        'action' => '\OpenAPI\Client\Model\ActionTypeEnum',
        'method_name' => 'string',
        'target' => 'string',
        'payload' => 'string'
    ];
    ...
    */
    ...
    public function setConnectionString($connection_string)
    {
        ...
        if ((mb_strlen($connection_string) < 1)) {
            throw new \InvalidArgumentException('invalid length for $connection_string when calling SignalRRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setHubName($hub_name)
    {
        ...
        if ((mb_strlen($hub_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hub_name when calling SignalRRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Gets action
     *
     * @return \OpenAPI\Client\Model\ActionTypeEnum
     */
     ...
     * Sets action
     *
     * @param \OpenAPI\Client\Model\ActionTypeEnum $action action
     *
     * @return self
     */
