...
/**
 * SchemaScriptsDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SchemaScriptsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SchemaScriptsDto';
    ...
    */
     ...
     * Sets query
     *
     * @param string|null $query The script that is executed for each content when querying contents.
     *
     * @return self
     */
     ...
     * Sets query_pre
     *
     * @param string|null $query_pre The script that is executed for all contents when querying contents.
     *
     * @return self
     */
     ...
     * Sets create
     *
     * @param string|null $create The script that is executed when creating a content.
     *
     * @return self
     */
     ...
     * Sets change
     *
     * @param string|null $change The script that is executed when change a content status.
     *
     * @return self
     */
    ...
    {
        if (is_null($change)) {
            array_push($this->openAPINullablesSetToNull, 'change');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('change', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
