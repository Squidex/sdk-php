...
/**
 * ReorderFieldsDto Class Doc Comment
 *
 * @category Class
 * @package  Squidex\Client
 * @author   OpenAPI Generator team
 ...
 */
class ReorderFieldsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReorderFieldsDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['field_ids'] === null) {
            $invalidProperties[] = "'field_ids' can't be null";
        }
     ...
     * Sets field_ids
     *
     * @param int[] $field_ids The field ids in the target order.
     *
     * @return self
     */
