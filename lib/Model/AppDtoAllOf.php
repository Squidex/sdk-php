 ...
 */
class AppDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppDto_allOf';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[a-z0-9]+(\\-[a-z0-9]+)*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling AppDtoAllOf., must conform to the pattern /^[a-z0-9]+(\\-[a-z0-9]+)*$/.");
        }
