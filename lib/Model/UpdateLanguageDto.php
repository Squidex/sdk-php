...
/**
 * UpdateLanguageDto Class Doc Comment
 *
 * @category Class
 * @package  Squidex\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateLanguageDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateLanguageDto';
    ...
    */
     ...
     * Sets is_master
     *
     * @param bool|null $is_master Set the value to true to make the language the master.
     *
     * @return self
     */
    public function setIsMaster($is_master)
    {
        if (is_null($is_master)) {
            array_push($this->openAPINullablesSetToNull, 'is_master');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_master', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets is_optional
     *
     * @param bool|null $is_optional Set the value to true to make the language optional.
     *
     * @return self
     */
     ...
     * Sets fallback
     *
     * @param string[]|null $fallback Optional fallback languages.
     *
     * @return self
     */
