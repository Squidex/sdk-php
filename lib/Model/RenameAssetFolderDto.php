...
/**
 * RenameAssetFolderDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RenameAssetFolderDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenameAssetFolderDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['folder_name']) < 1)) {
    ...
    public function setFolderName($folder_name)
    {
        ...
        if ((mb_strlen($folder_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $folder_name when calling RenameAssetFolderDto., must be bigger than or equal to 1.');
        }
