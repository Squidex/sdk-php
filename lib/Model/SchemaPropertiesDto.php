...
class SchemaPropertiesDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $attributeMap = [
        ...
        'contents_editor_url' => 'contentsEditorUrl',
    ...
    protected static $setters = [
        ...
        'contents_editor_url' => 'setContentsEditorUrl',
    ...
    protected static $getters = [
        ...
        'contents_editor_url' => 'getContentsEditorUrl',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('contents_editor_url', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets contents_editor_url
     *
     * @return string|null
     */
    public function getContentsEditorUrl()
    {
        return $this->container['contents_editor_url'];
    }

    /**
     * Sets contents_editor_url
     *
     * @param string|null $contents_editor_url The url to the editor plugin.
     *
     * @return self
     */
    public function setContentsEditorUrl($contents_editor_url)
    {
        if (is_null($contents_editor_url)) {
            array_push($this->openAPINullablesSetToNull, 'contents_editor_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('contents_editor_url', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['contents_editor_url'] = $contents_editor_url;
