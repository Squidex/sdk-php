...
class BulkUpdateContentsJobDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'enrich_defaults' => 'setEnrichDefaults',
    ...
    protected static $getters = [
        ...
        'enrich_defaults' => 'getEnrichDefaults',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('enrich_defaults', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets enrich_defaults
     *
     * @return bool|null
     */
    public function getEnrichDefaults()
    {
        return $this->container['enrich_defaults'];
    }

    /**
     * Sets enrich_defaults
     *
     * @param bool|null $enrich_defaults Enrich the data with the default values when updating a content item.
     *
     * @return self
     */
    public function setEnrichDefaults($enrich_defaults)
    {
        if (is_null($enrich_defaults)) {
            throw new \InvalidArgumentException('non-nullable enrich_defaults cannot be null');
        }
        $this->container['enrich_defaults'] = $enrich_defaults;
