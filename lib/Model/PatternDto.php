 ...
 */
class PatternDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatternDto';
    ...
    */
     ...
     * Sets message
     *
     * @param string|null $message The regex message.
     *
     * @return self
     */
