...
class UpsertSchemaFieldDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'nested' => '\OpenAPI\Client\Model\UpsertSchemaNestedFieldDto[]'
    ];
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpsertSchemaFieldDto., must be bigger than or equal to 1.');
        }
     ...
     * Gets nested
     *
     * @return \OpenAPI\Client\Model\UpsertSchemaNestedFieldDto[]|null
     */
     ...
     * Sets nested
     *
     * @param \OpenAPI\Client\Model\UpsertSchemaNestedFieldDto[]|null $nested The nested fields.
     *
     * @return self
     */
