...
class Configuration
{
     ...
     *
     * @param string $clientId Token for OAuth
     *
     * @return $this
     */
     ...
     *
     * @param string $clientSecret Token for OAuth
     *
     * @return $this
     */
    ...
    {
        $report  = 'PHP SDK (Squidex\Client) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.0.0' . PHP_EOL;
