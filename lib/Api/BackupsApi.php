...
/**
    ...
    /**
     * Operation getBackupContentWithHttpInfo
     *
     * Get the backup content.
     *
     * @param  string $app The name of the app. (required)
    ...
    /**
     * Operation getBackupContentAsync
     *
     * Get the backup content.
     *
     * @param  string $app The name of the app. (required)
    ...
    /**
     * Operation getBackupContentAsyncWithHttpInfo
     *
     * Get the backup content.
     *
     * @param  string $app The name of the app. (required)
    ...
    /**
     * Operation getBackupContentV2WithHttpInfo
     *
     * Get the backup content.
     *
     * @param  string $id The ID of the backup. (required)
    ...
    /**
     * Operation getBackupContentV2Async
     *
     * Get the backup content.
     *
     * @param  string $id The ID of the backup. (required)
    ...
    /**
     * Operation getBackupContentV2AsyncWithHttpInfo
     *
     * Get the backup content.
     *
     * @param  string $id The ID of the backup. (required)
    ...
    /**
     * Create request for operation 'getBackupContentV2'
     *
     * @param  string $id The ID of the backup. (required)
     * @param  string $app_id The ID of the app. (optional)
     * @param  string $app The name of the app. (optional, default to '')
    ...
    /**
     * Operation postBackupWithHttpInfo
     *
     * Start a new backup.
     *
     * @param  string $app The name of the app. (required)
    ...
    /**
     * Operation postBackupAsyncWithHttpInfo
     *
     * Start a new backup.
     *
     * @param  string $app The name of the app. (required)
    ...
    {
        list($response) = $this->getRestoreJobWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getRestoreJobWithHttpInfo
     *
     * Get current restore status.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRestoreJob'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRestoreJobAsync(string $contentType = self::contentTypes['getRestoreJob'][0])
    {
        return $this->getRestoreJobAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRestoreJobAsyncWithHttpInfo
     *
     * Get current restore status.
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRestoreJob'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'getRestoreJob'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRestoreJob'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRestoreJobRequest(string $contentType = self::contentTypes['getRestoreJob'][0])
    {
     ...
     * @return void
     */
    public function postRestoreJob($restore_request_dto, string $contentType = self::contentTypes['postRestoreJob'][0])
    {
        $this->postRestoreJobWithHttpInfo($restore_request_dto, $contentType);
    }

    /**
     * Operation postRestoreJobWithHttpInfo
     *
     * Restore a backup.
     *
     * @param  \Squidex\Client\Model\RestoreRequestDto $restore_request_dto The backup to restore. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function postRestoreJobWithHttpInfo($restore_request_dto, string $contentType = self::contentTypes['postRestoreJob'][0])
    {
        $request = $this->postRestoreJobRequest($restore_request_dto, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postRestoreJobAsync($restore_request_dto, string $contentType = self::contentTypes['postRestoreJob'][0])
    {
        return $this->postRestoreJobAsyncWithHttpInfo($restore_request_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postRestoreJobAsyncWithHttpInfo
     *
     * Restore a backup.
     *
     * @param  \Squidex\Client\Model\RestoreRequestDto $restore_request_dto The backup to restore. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postRestoreJobAsyncWithHttpInfo($restore_request_dto, string $contentType = self::contentTypes['postRestoreJob'][0])
    {
        $returnType = '';
        $request = $this->postRestoreJobRequest($restore_request_dto, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postRestoreJobRequest($restore_request_dto, string $contentType = self::contentTypes['postRestoreJob'][0])
    {
