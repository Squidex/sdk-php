...
/**
     ...
     * @param  \Squidex\Client\Model\AskDto $ask_dto The question request. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postQuestion'] to see the possible values for this operation
     *
     * @throws \Squidex\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string[]|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto
     */
    public function postQuestion($app, $ask_dto, string $contentType = self::contentTypes['postQuestion'][0])
    {
        list($response) = $this->postQuestionWithHttpInfo($app, $ask_dto, $contentType);
        return $response;
    }

    /**
     * Operation postQuestionWithHttpInfo
     *
     * Asks the chatbot a question a text.
     *
     * @param  string $app The name of the app. (required)
     ...
     * @throws \Squidex\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string[]|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function postQuestionWithHttpInfo($app, $ask_dto, string $contentType = self::contentTypes['postQuestion'][0])
    {
        $request = $this->postQuestionRequest($app, $ask_dto, $contentType);
     ...
     */
    public function postQuestionAsync($app, $ask_dto, string $contentType = self::contentTypes['postQuestion'][0])
    {
        return $this->postQuestionAsyncWithHttpInfo($app, $ask_dto, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postQuestionAsyncWithHttpInfo
     *
     * Asks the chatbot a question a text.
     *
     * @param  string $app The name of the app. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postQuestionAsyncWithHttpInfo($app, $ask_dto, string $contentType = self::contentTypes['postQuestion'][0])
    {
        $returnType = 'string[]';
        $request = $this->postQuestionRequest($app, $ask_dto, $contentType);
    ...
    /**
     * Create request for operation 'postQuestion'
     *
     * @param  string $app The name of the app. (required)
     * @param  \Squidex\Client\Model\AskDto $ask_dto The question request. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postQuestion'] to see the possible values for this operation
     ...
     */
    public function postQuestionRequest($app, $ask_dto, string $contentType = self::contentTypes['postQuestion'][0])
    {
        ...
        // verify the required parameter 'ask_dto' is set
        if ($ask_dto === null || (is_array($ask_dto) && count($ask_dto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $ask_dto when calling '
            );
        }


        $resourcePath = '/api/apps/{app}/ask';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($ask_dto)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($ask_dto));
            } else {
                $httpBody = $ask_dto;
            }
