...
/**
     ...
     */
    public function postAsset($parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        list($response) = $this->postAssetWithHttpInfo($parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType);
        return $response;
    }
     ...
     */
    public function postAssetWithHttpInfo($parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        $request = $this->postAssetRequest($parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postAssetAsync($parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        return $this->postAssetAsyncWithHttpInfo($parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postAssetAsyncWithHttpInfo($parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        $returnType = '\Squidex\Client\Model\AssetDto';
        $request = $this->postAssetRequest($parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto
     */
    public function postUpsertAsset($id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        list($response) = $this->postUpsertAssetWithHttpInfo($id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType);
        return $response;
    }
     ...
     * @return array of \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUpsertAssetWithHttpInfo($id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        $request = $this->postUpsertAssetRequest($id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUpsertAssetAsync($id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        return $this->postUpsertAssetAsyncWithHttpInfo($id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUpsertAssetAsyncWithHttpInfo($id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        $returnType = '\Squidex\Client\Model\AssetDto';
        $request = $this->postUpsertAssetRequest($id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto
     */
    public function putAssetContent($id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        list($response) = $this->putAssetContentWithHttpInfo($id, $file, $file_url, $file_name, $contentType);
        return $response;
    }
     ...
     * @return array of \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function putAssetContentWithHttpInfo($id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        $request = $this->putAssetContentRequest($id, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putAssetContentAsync($id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        return $this->putAssetContentAsyncWithHttpInfo($id, $file, $file_url, $file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putAssetContentAsyncWithHttpInfo($id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        $returnType = '\Squidex\Client\Model\AssetDto';
        $request = $this->putAssetContentRequest($id, $file, $file_url, $file_name, $contentType);
