...
/**
     ...
     */
    public function postAsset($app, $parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        list($response) = $this->postAssetWithHttpInfo($app, $parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType);
        return $response;
    }
     ...
     */
    public function postAssetWithHttpInfo($app, $parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        $request = $this->postAssetRequest($app, $parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postAssetAsync($app, $parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        return $this->postAssetAsyncWithHttpInfo($app, $parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postAssetAsyncWithHttpInfo($app, $parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
        $returnType = '\Squidex\Client\Model\AssetDto';
        $request = $this->postAssetRequest($app, $parent_id, $id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postAssetRequest($app, $parent_id = null, $id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postAsset'][0])
    {
     ...
     * @return \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto
     */
    public function postUpsertAsset($app, $id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        list($response) = $this->postUpsertAssetWithHttpInfo($app, $id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType);
        return $response;
    }
     ...
     * @return array of \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function postUpsertAssetWithHttpInfo($app, $id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        $request = $this->postUpsertAssetRequest($app, $id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUpsertAssetAsync($app, $id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        return $this->postUpsertAssetAsyncWithHttpInfo($app, $id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postUpsertAssetAsyncWithHttpInfo($app, $id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
        $returnType = '\Squidex\Client\Model\AssetDto';
        $request = $this->postUpsertAssetRequest($app, $id, $parent_id, $duplicate, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function postUpsertAssetRequest($app, $id, $parent_id = null, $duplicate = null, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['postUpsertAsset'][0])
    {
     ...
     * @return \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto
     */
    public function putAssetContent($app, $id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        list($response) = $this->putAssetContentWithHttpInfo($app, $id, $file, $file_url, $file_name, $contentType);
        return $response;
    }
     ...
     * @return array of \Squidex\Client\Model\AssetDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto|\Squidex\Client\Model\ErrorDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function putAssetContentWithHttpInfo($app, $id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        $request = $this->putAssetContentRequest($app, $id, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putAssetContentAsync($app, $id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        return $this->putAssetContentAsyncWithHttpInfo($app, $id, $file, $file_url, $file_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function putAssetContentAsyncWithHttpInfo($app, $id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
        $returnType = '\Squidex\Client\Model\AssetDto';
        $request = $this->putAssetContentRequest($app, $id, $file, $file_url, $file_name, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function putAssetContentRequest($app, $id, $file = null, $file_url = null, $file_name = null, string $contentType = self::contentTypes['putAssetContent'][0])
    {
