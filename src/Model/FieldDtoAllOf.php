...
/**
 * FieldDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FieldDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FieldDto_allOf';
    ...
    protected static $openAPITypes = [
        ...
        'nested' => '\OpenAPI\Client\Model\NestedFieldDto[]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['partitioning'] === null) {
            $invalidProperties[] = "'partitioning' can't be null";
        }
        if ((mb_strlen($this->container['partitioning']) < 1)) {
            $invalidProperties[] = "invalid value for 'partitioning', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FieldDtoAllOf., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-z0-9]+(\\-[a-z0-9]+)*$/", $name))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling FieldDtoAllOf., must conform to the pattern /^[a-z0-9]+(\\-[a-z0-9]+)*$/.");
        }
     ...
     * Sets is_hidden
     *
     * @param bool $is_hidden Defines if the field is hidden.
     *
     * @return self
     */
     ...
     * Sets is_locked
     *
     * @param bool $is_locked Defines if the field is locked.
     *
     * @return self
     */
     ...
     * Sets is_disabled
     *
     * @param bool $is_disabled Defines if the field is disabled.
     *
     * @return self
     */
     ...
     * Sets partitioning
     *
     * @param string $partitioning Defines the partitioning of the field.
     *
     * @return self
     */
    public function setPartitioning($partitioning)
    {
        ...
        if ((mb_strlen($partitioning) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partitioning when calling FieldDtoAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Gets nested
     *
     * @return \OpenAPI\Client\Model\NestedFieldDto[]|null
     */
     ...
     * Sets nested
     *
     * @param \OpenAPI\Client\Model\NestedFieldDto[]|null $nested The nested fields.
     *
     * @return self
     */
