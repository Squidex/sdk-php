...
/**
 * TranslateDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TranslateDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TranslateDto';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['target_language']) < 1)) {
            $invalidProperties[] = "invalid value for 'target_language', the character length must be bigger than or equal to 1.";
        }
     ...
     *
     * @param string|null $source_language The optional source language.
     *
     * @return self
     */
