...
/**
 * EmailRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailRuleActionDto_allOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['server_username']) < 1)) {
            $invalidProperties[] = "invalid value for 'server_username', the character length must be bigger than or equal to 1.";
        }

        if ($this->container['server_password'] === null) {
            $invalidProperties[] = "'server_password' can't be null";
        }
        if ((mb_strlen($this->container['server_password']) < 1)) {
            $invalidProperties[] = "invalid value for 'server_password', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setServerHost($server_host)
    {
        ...
        if ((mb_strlen($server_host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $server_host when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setServerUsername($server_username)
    {
        ...
        if ((mb_strlen($server_username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $server_username when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setServerPassword($server_password)
    {
        ...
        if ((mb_strlen($server_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $server_password when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setMessageFrom($message_from)
    {
        ...
        if ((mb_strlen($message_from) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message_from when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setMessageTo($message_to)
    {
        ...
        if ((mb_strlen($message_to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message_to when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setMessageSubject($message_subject)
    {
        ...
        if ((mb_strlen($message_subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message_subject when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setMessageBody($message_body)
    {
        ...
        if ((mb_strlen($message_body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $message_body when calling EmailRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
