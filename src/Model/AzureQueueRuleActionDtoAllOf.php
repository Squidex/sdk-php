...
/**
 * AzureQueueRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AzureQueueRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AzureQueueRuleActionDto_allOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['queue']) < 1)) {
     ...
     *
     * @param string $connection_string The connection string to the storage account.
     *
     * @return self
     */
    public function setConnectionString($connection_string)
    {
        ...
        if ((mb_strlen($connection_string) < 1)) {
            throw new \InvalidArgumentException('invalid length for $connection_string when calling AzureQueueRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setQueue($queue)
    {
        ...
        if ((mb_strlen($queue) < 1)) {
            throw new \InvalidArgumentException('invalid length for $queue when calling AzureQueueRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
