...
/**
 * ElasticSearchRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ElasticSearchRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ElasticSearchRuleActionDto_allOf';
    ...
    */
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $host when calling ElasticSearchRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setIndexName($index_name)
    {
        ...
        if ((mb_strlen($index_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $index_name when calling ElasticSearchRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Sets username
     *
     * @param string|null $username The optional username.
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password The optional password.
     *
     * @return self
     */
