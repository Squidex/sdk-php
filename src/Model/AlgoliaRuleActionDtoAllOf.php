...
/**
 * AlgoliaRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AlgoliaRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlgoliaRuleActionDto_allOf';
    ...
    */
    ...
    public function setAppId($app_id)
    {
        ...
        if ((mb_strlen($app_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $app_id when calling AlgoliaRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setApiKey($api_key)
    {
        ...
        if ((mb_strlen($api_key) < 1)) {
            throw new \InvalidArgumentException('invalid length for $api_key when calling AlgoliaRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setIndexName($index_name)
    {
        ...
        if ((mb_strlen($index_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $index_name when calling AlgoliaRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
