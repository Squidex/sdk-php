 ...
 */
class UpdateAppSettingsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateAppSettingsDto';
    ...
    */
     ...
     * Sets hide_scheduler
     *
     * @param bool|null $hide_scheduler Hide the scheduler for content items.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $hide_date_time_mode_button Hide the datetime mode button.
     *
     * @return self
     */
