...
/**
 * WorkflowDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WorkflowDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkflowDto_allOf';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'steps' => 'array<string,\OpenAPI\Client\Model\WorkflowStepDto>',
        'schema_ids' => 'string[]',
        'initial' => 'string'
    ];
    ...
    */
     ...
     * Gets steps
     *
     * @return array<string,\OpenAPI\Client\Model\WorkflowStepDto>
     */
     ...
     * Sets steps
     *
     * @param array<string,\OpenAPI\Client\Model\WorkflowStepDto> $steps The workflow steps.
     *
     * @return self
     */
     ...
     * Sets schema_ids
     *
     * @param string[]|null $schema_ids The schema ids.
     *
     * @return self
     */
     ...
     * Sets initial
     *
     * @param string $initial The initial step.
     *
     * @return self
     */
