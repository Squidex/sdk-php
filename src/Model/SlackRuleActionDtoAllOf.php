...
/**
 * SlackRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SlackRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SlackRuleActionDto_allOf';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['webhook_url']) < 1)) {
    ...
    public function setWebhookUrl($webhook_url)
    {
        ...
        if ((mb_strlen($webhook_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $webhook_url when calling SlackRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Sets text
     *
     * @param string $text The text that is sent as message to slack.
     *
     * @return self
     */
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $text when calling SlackRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
