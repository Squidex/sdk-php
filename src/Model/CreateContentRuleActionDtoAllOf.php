...
/**
 * CreateContentRuleActionDtoAllOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateContentRuleActionDtoAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateContentRuleActionDto_allOf';
    ...
    */
    ...
    public function setData($data)
    {
        ...
        if ((mb_strlen($data) < 1)) {
            throw new \InvalidArgumentException('invalid length for $data when calling CreateContentRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
    ...
    public function setSchema($schema)
    {
        ...
        if ((mb_strlen($schema) < 1)) {
            throw new \InvalidArgumentException('invalid length for $schema when calling CreateContentRuleActionDtoAllOf., must be bigger than or equal to 1.');
        }
     ...
     * Sets client
     *
     * @param string $client An optional client name.
     *
     * @return self
     */
     ...
     * Sets publish
     *
     * @param bool $publish Publish the content.
     *
     * @return self
     */
