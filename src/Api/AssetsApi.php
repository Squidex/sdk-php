...
/**
     ...
     * @param  \OpenAPI\Client\Model\ResizeMode $mode The resize mode when the width and height is defined. (optional)
     ...
     * @param  \OpenAPI\Client\Model\ImageFormat $format True to force a new resize even if it already stored. (optional)
     ...
     * @param  \OpenAPI\Client\Model\AssetFolderScope $scope The scope of the query. (optional)
